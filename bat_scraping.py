...
try: 
    ...
    data_to_write = saved_data_dict = {"last_viewed":start_num, "written_data":main_data, "links":links}
    write('bat_data.json', data_to_write)
    print('an error occured. data was saved.')
    
# error is where an auction is withdrawn - no 'info-value noborder-tiny' html class there
# also works through webdriver - still need to work through the withdrawn issue